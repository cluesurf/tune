...
**The quest: an unambiguous joining system over 22 consonants and
5 vowels.** Every compound must read exactly one way, and
...
Every figure is measured over all 16,777,216 ordered
pairs of 4,096 roots, drawn across the
...
| none in the pool | `r` | the same, after a coda opening on `z` | above |
...
pool of 4,096 would otherwise spell two
...
one way. Deeper compounds are the 23 above.
